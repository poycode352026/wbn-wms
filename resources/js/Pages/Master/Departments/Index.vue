...
.modal{background:var(--surface);border:1px solid var(--border-2);border-radius:16px;width:100%;max-width:520px;box-shadow:var(--shadow-lg);display:flex;flex-direction:column;max-height:90vh;overflow:visible}
...
.bcn{padding:9px 18px;border-radius:9px;border:1px solid var(--border-2);background:transparent;color:var(--fg-2);font-size:13.5px;font-family:inherit;cursor:pointer;transition:all 160ms}.bcn:hover{background:var(--hover);color:var(--fg)}
